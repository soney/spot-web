...
export default class extends React.Component<CVPageProps, CVPageState> {
    ...
    private getPubListElement(types: PUB_TYPES[]): JSX.Element {
        ...
        const rows = filteredRows.map((pub) => {
            ...
            const authorNames = pub.authors.map((author) => {
                ...
                return <span className={classNames} key={author.id} itemProp="author">{fullName}</span>
            });
            ...
            const row = <li className="paper row" key={pub.id}>
                <div className="col main" itemScope itemType="https://schema.org/ScholarlyArticle">
                    {shortAuthors}. (<span itemProp="datePublished">{pub.venue.year}</span>) <cite itemProp="name">{pub.title}</cite>. <i>{venueString}</i>. {locationString} {pub.pub_details}
        ...
        return <ul className="unstyled-list">{rows}</ul>;
    }
    public render() {
        ...
        return <div className="cv container">
            ...
            <div className="row">
                <div className="col main">
                    <div className="row">
                        <address className="col affiliation">
                ...
                <ul className="unstyled-list">
                    {
                        data.strapiLeadcv.professional_experience.map((exp) => (
                            <li className="row item" key={exp.id}>
                                <div className="col main">
                ...
                </div>
                {
                    [
                        ...
                        <>
                            ...
                            {this.getPubListElement(pubElementTypes as PUB_TYPES[])}
                        </>
                    ))
                }
            </div>
                ...
                <ul className="unstyled-list">
                    {
                        data.strapiLeadcv.grants.map((grant) => (
                            <li className="row item" key={grant.id}>
                                <div className="col main">
                ...
                <ul className="unstyled-list">
                    {
                        [
                            ...
                            if (award.hasOwnProperty('venue')) { // publication
                                ...
                                return <li className="row item" key={award_item.id}>
                                    <div className="col main">
                ...
                <ul className="unstyled-list">
                    {
                        data.strapiLeadcv.invited_presentations.map((talk, index) => (
                            <li className="row item" key={talk.id}>
                                <div className="col main">
                            ...
                            <ul className="unstyled-list">
                                {
                                    data.strapiLeadcv.service.filter((service_item) => service_item.category === category).map((service_item) => (
                                        <li className="row item" key={service_item.id}>
                                            <div className="col main">
                            ...
                            <ul className="unstyled-list">
                                {
                                    data.strapiLeadcv.supervised_students.filter((student) => student.category === category).map((student) => (
                                        <li className="row item" key={student.id}>
                                            <div className="col main">
                ...
                <ul className="unstyled-list">
                    {
                        data.strapiLeadcv.press.map((press) => (
                            <li className="row item" key={press.id}>
                                <div className="col main">
                ...
                <ul className="unstyled-list">
                    {
                        data.strapiLeadcv.patents.map((patent) => (
                            <li className="row" key={patent.id}>
